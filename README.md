...
I have managed products from idea to delivery across AI, mobile and web. I have used customer insight, data, research and feedback loops to shape features. I have run A/B tests, fixed root-cause issues and launched improvements that lifted accuracy, trust and adoption. My work shows clear product thinking, structured delivery and a focus on solving real customer problems.
